...
<div className="text-9xl skill link" id="Contact">Contact</div>
    <div className=" m-auto flex items-center  justify-center" >
      <div className="contactContainer  mb-6 flex justify-evenly items-center">
        <div className="contactByIcon flex flex-row ">
          <div>
            <div>
              <a
            ...
            <div>
              <a href="mailto: amansoni20020+work@gmail.com" className="">
                <img
                  alt="svgImg"
                  className="black"
          ...
          <div>
            <div>
              <a href=" https://github.com/aam2002" className="">
                <img
                  alt="svgImg"
                  className="black"
        ...
        <div className="contact-form flex flex-col">
          ...
          >
            <h2 className=" text-4xl flex m-4 ">Get in Touch With Me</h2>
            <input
              type="text"
              name="username"
              placeholder="Name"
